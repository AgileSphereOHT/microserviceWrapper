...
public class DelegatorTests {
    ...
    private static Logger logger = LoggerFactory.getLogger(DelegatorTests.class);
    ...
    public void testLibraryClassInstantationWithZeroParamMethodOK() {
        ...
        Delegator delegator = new Delegator(loader, LIBRARY_CLASS_NO_ARG_CONS_NAME, METHOD_WITH_NO_PARAMS_NAME, ZERO_PARAMETERS);
    ...
    public void testLibraryClassInstantationWithOneParamMethodOK() {
        Class[] parameters = new Class[]{};
        Delegator delegator = new Delegator(loader, LIBRARY_CLASS_NO_ARG_CONS_NAME, METHOD_WITH_ONE_PARAM_NAME, ONE_PARAMETER);
        assertNotNull(delegator);
    }
    ...
    public void testLibraryClassInstantationWithTwoParamMethodOK() {
        Class[] parameters = new Class[]{};
        Delegator delegator = new Delegator(loader, LIBRARY_CLASS_NO_ARG_CONS_NAME, METHOD_WITH_TWO_PARAM_NAME, TWO_PARAMETERS);
        assertNotNull(delegator);
    }
    ...
    public void testLibraryClassInstantationWithThreeParamMethodOK() {
        Class[] parameters = new Class[]{};
        Delegator delegator = new Delegator(loader, LIBRARY_CLASS_NO_ARG_CONS_NAME, METHOD_WITH_THREE_PARAM_NAME, THREE_PARAMETERS);
        assertNotNull(delegator);
    }
    ...
    public void testInvalidClassRequested() {
        ...
        Delegator delegator = new Delegator(loader, LIBRARY_CLASS_DOES_NOT_EXIST_NAME, METHOD_DOES_NOT_EXIST_NAME, ZERO_PARAMETERS);
    }
    ...
    public void testInvalidNoParamMethodRequested() {
        ...
        expectedException.expect(DelegatorConfigurationException.class);
        expectedException.expectMessage(expectedErrorMessage);
        Delegator delegator = new Delegator(loader, LIBRARY_CLASS_NO_ARG_CONS_NAME, METHOD_DOES_NOT_EXIST_NAME, ZERO_PARAMETERS);
    }
    ...
    public void testInvalidTooManyParamsMethodRequested() {
        ...
        expectedException.expect(DelegatorConfigurationException.class);
        expectedException.expectMessage(expectedErrorMessage);
        Delegator delegator = new Delegator(loader, LIBRARY_CLASS_NO_ARG_CONS_NAME, METHOD_WITH_ONE_PARAM_NAME, TWO_PARAMETERS);
    }
    ...
    public void testInvalidConstructorRequested() {
        ...
        Delegator delegator = new Delegator(loader, LIBRARY_CLASS_WITH_ARG_CONS_NAME, METHOD_WITH_NO_PARAMS_NAME, ZERO_PARAMETERS);
    }
    ...
    */
    ...
    public void testMethodInvocationWithThreeParamsAndArrayResponseSuccess() {
        Delegator delegator = new Delegator(loader, LIBRARY_CLASS_NO_ARG_CONS_NAME, METHOD_WITH_THREE_PARAM_AS_ARRAY_NAME, THREE_PARAMETERS);
        String[] threeParams = {"param1", "param2", "param3"};
        String[] result = (String[]) delegator.invokeMethod(threeParams);
    ...
    public void testMethodInvocationWithThreeParamsAndListResponseSuccess() {
        Delegator delegator = new Delegator(loader, LIBRARY_CLASS_NO_ARG_CONS_NAME, METHOD_WITH_THREE_PARAM_AS_LIST_NAME, THREE_PARAMETERS);
        String[] threeParams = {"param1", "param2", "param3"};
    ...
    public void testMethodInvocationWithThreeParamsAndMapResponseSuccess() {
        Delegator delegator = new Delegator(loader, LIBRARY_CLASS_NO_ARG_CONS_NAME, METHOD_WITH_THREE_PARAM_AS_MAP_NAME, THREE_PARAMETERS);
        String[] threeParams = {"param1", "param2", "param3"};
